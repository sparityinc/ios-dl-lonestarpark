...
- (void)refreshBalance
{
    ...
    [[ZLAppDelegate getApiWrapper] refreshBalance:NO success:^(NSDictionary* _userInfo){
        ...
        if ([[_userInfo objectForKey:@"response-status"]isEqualToString:@"success"]) {
            isRecievedBalance = YES;
...
- (void)loadData
{
    ...
    [dic setObject:[UIColor colorWithRed:101.0/255 green:145.0/255 blue:83.0/255 alpha:1.0] forKey:@"backgroundColor"];
    ...
    if ([self.numberArray count]>0) {
        ...
        if ([cell.titleLabel.text isEqualToString:@"Wallet"])
        {
            ...
            [cell.badgeButton setTitle:[NSString stringWithFormat:@"Balance: $%.2f", [ZLAppDelegate getAppData].balanceAmount] forState:UIControlStateNormal];
               ...
               [cell.badgeButton setTitle:@"Loading..."forState:UIControlStateNormal];
            }
        }
