...
- (void)liveVideoUrlCallFromServer
{
    ...
    NSDictionary *videoDict = [NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%@",CLIENT_ID],@"client_id",@"live",@"videoType",@"stream",@"format",trackCode,@"track_code",meetNo,@"meet", nil];
...
- (IBAction)videoButtonClicked:(id)sender
{
    ...
    NSDictionary *videoDict = [NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%@",CLIENT_ID],@"client_id",@"live",@"videoType",@"stream",@"format",raceCard.eventCode,@"track_code",[NSString stringWithFormat:@"%d",[ZLAppDelegate getAppData].currentWager.selectedRaceId],@"race_number",meetNo,@"meet", nil];
