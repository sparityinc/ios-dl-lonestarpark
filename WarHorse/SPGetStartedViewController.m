...
- (void)viewDidLoad
{
    ...
    imageArray = [[NSMutableArray alloc] initWithObjects:@"tutorial1", @"tutorial2",@"tutorial3", @"tutorial4", @"tutorial5", @"tutorial6", @"tutorial7", @"tutorial8", @"tutorial9", @"tutorial10", @"tutorial11", @"tutorial12", @"tutorial13", @"tutorial14", nil];
...
{
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:CLIENT_NAME message:Mess delegate:self cancelButtonTitle:@"OK" otherButtonTitles:@"Cancel", nil];//The End of Tutorial
    [alert show];
}
