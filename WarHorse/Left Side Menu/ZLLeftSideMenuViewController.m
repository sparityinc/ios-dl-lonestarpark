...
- (void)viewDidLoad
{
    ...
    if ([[[WarHorseSingleton sharedInstance] isOntEnable] isEqualToString:@"true"]){
        ...
        NSMutableDictionary *dic11 = [NSMutableDictionary dictionary];
        [dic11 setValue:@"Live Videos" forKey:@"title"];
        [dic11 setObject:[UIImage imageNamed:@"videos.png"] forKey:@"logo"];
        [dic11 setObject:[NSNumber numberWithInt:DashBoardVideoReplay] forKey:@"enumValue"];
        [self.itemsArray addObject:dic11];
           }
