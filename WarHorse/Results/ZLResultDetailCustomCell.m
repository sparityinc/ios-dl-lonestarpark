...
- (void)updateViewAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (indexPath.section == 2)
    {
        ...
        self.numberLabel.hidden = NO;
            ...
            if(scratcher ){
                [self.titleLabel setFrame:CGRectMake(8, 2.5, 255, 20)];
                [self.detailLabel setFrame:CGRectMake(22, 2.5, 255, 20)];
                
                self.titleLabel.text = [NSString stringWithFormat:@"%d",scratcher.runnerPosition];//
                self.detailLabel.text = [NSString stringWithFormat:@"%@",scratcher.horseName];
                [self.detailLabel setFont:[UIFont fontWithName:@"Roboto-Medium" size:12]];
                [self.titleLabel setFont:[UIFont fontWithName:@"Roboto-Medium" size:12]];
