...
- (void)loadData
{
    ...
    [tabledic5 setValue:[NSString stringWithFormat:@"About %@",CLIENT_NAME] forKey:@"title"];
...
{
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:CLIENT_NAME message:self.geoFencingErrorStr delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [alert show];
